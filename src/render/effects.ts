...
const SHAKE_DECAY_PER_MS = 0.006;       // exponential decay
...
export class Effects {
  ...
  /** Floating score popups + foul red flash — drawn after the HUD. */
  ...
  private handleClear(ev: ClearEvent, layout: Layout): void {
    ...
    // Screen shake: bigger for big moments
    let shake = 5;
    ...
    // Score popup at the centroid of the largest line
